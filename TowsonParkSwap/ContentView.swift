...
struct ContentView: View {
    ...
    @StateObject var availableList = AvailableList()
    @StateObject var fulfillmentList = FulfillmentList()
    ...
    var body: some View {
        ...
        .environmentObject(availableList)
        .environmentObject(fulfillmentList)
    }
}
